...
TASK_TOOL_DESCRIPTION = """Launch a configured 地智 subagent to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured 地智 subagent asynchronously.
