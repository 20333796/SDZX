              ...
              <div class="tab-content-wrapper">
                <a-form layout="vertical" class="remote-install-form">
                  ...
                  <div class="repo-hint-text">
                    支持 `owner/repo` 或 Git 仓库地址。可前往
                    <a href="https://skills.sh/" target="_blank" rel="noopener noreferrer"
                      >skills.sh</a
                    >
                    查询可安装 skills。也支持 ModelScope 单个 Skill
            ...
            <a-tab-pane key="search" tab="全局搜索发现">
              <div class="tab-content-wrapper">
                <a-form layout="vertical" class="remote-install-form">
                  ...
                  <div class="repo-hint-text">
                    直接输入关键字检索 skills.sh 上的 Skills 并批量拉取安装。
                  </div>
...
const RECOMMENDED_SUITES = [
  {
    ...
    provider: 'MiniMax-AI',
    description:
      'MiniMax 办公文档 Skills 合集，覆盖 DOCX、PDF、XLSX 与 PPTX 演示文稿的创建与格式化。',
