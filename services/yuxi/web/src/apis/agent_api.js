import { apiGet, apiPost, apiDelete, apiPut, apiRequest, withApiBasePath } from './base'
...
export const agentApi = {
  ...
  streamRequestEvents: (requestId, options = {}) => {
    ...
    return fetch(withApiBasePath(`/api/agent/requests/${requestId}/events`), {
      method: 'GET',
      headers,
      signal
    })
  ...
  streamAgentRunEvents: (runId, afterSeq = '0-0', options = {}) => {
    ...
    return fetch(withApiBasePath(`/api/agent/runs/${runId}/events?${params.toString()}`), {
      method: 'GET',
      headers,
      signal
    })
